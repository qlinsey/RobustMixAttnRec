...
def negative_sampler_factory(
    code, user2dict, user_count, item_count, sample_size, seed, save_folder
):
    negative_sampler = NEGATIVE_SAMPLERS[code]
    return negative_sampler(
        user2dict, user_count, item_count, sample_size, seed, save_folder
    )
